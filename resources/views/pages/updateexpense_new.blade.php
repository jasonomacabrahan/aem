...
<!--        <div class="col-md-12"> -->
          <div class="card">
            <div class="card-header bg-info">
              <strong class="text-white"><i class="fa fa-fw fa-th-list"></i>Update Activity Expense Entry</strong>
            </div>
            ...
            <form action="{{ route('saveexpensesupdate_new') }}" method="POST" class="mt-1 py-3">
                @csrf
                ...
                @endforeach
                <a href="{{ route('activitymanagement') }}" class="btn btn-danger"><i class="fa-solid fa-fw fa-angle-left"></i>Back</a>
