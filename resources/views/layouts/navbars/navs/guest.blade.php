...
<nav class="navbar navbar-expand-lg bg-info navbar-absolute">
  <div class="container-fluid">
    <div class="navbar-wrapper text-white">
     <a href="{{ route('welcome') }}" style="text-decoration:none; display:inline;"><img src="{{ asset('assets').'/img/favicon.png' }}" style="width:50px;height:50px; padding: 0px; margin: 0px;" alt=" DICT XI ">  <span style="font-size: 20px; font-weight: bolder;">&nbspDICT XI  - AEM</span></a>
